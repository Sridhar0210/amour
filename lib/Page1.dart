...
import 'package:amour/page_4.dart';
import 'package:amour/search.dart';
                                      ...
                                      Row(children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                              ...
                                              child: const Center(child: Icon(Icons.directions_car,color:Colors.red,))),
                                        ),
      ...
      bottomNavigationBar: BottomNavigationBar(backgroundColor: Colors.black,
        ...
        items: [
          BottomNavigationBarItem(icon: GestureDetector(onTap:
            ...
            child: const Icon(Icons.home_outlined,color: Colors.white70,),
          ),label: "Home"
          ),

          BottomNavigationBarItem(icon: GestureDetector(onTap:
          (){
            Navigator.push(context, MaterialPageRoute(builder: (context)=> must()),
            );
          },
